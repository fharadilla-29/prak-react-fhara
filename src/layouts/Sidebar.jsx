import { MdSpaceDashboard, MdListAlt, MdPeople, MdFastfood, MdError, MdLock, MdBlock, MdLogout } from "react-icons/md";
        ...
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div id="sidebar-menu" className="mt-10">
                <ul id="menu-list" className="space-y-3">
                    ...
                    {/* PRODUK */}
                    <li>
                        <NavLink id="menu-5" to="/produk" className={menuClass}>
                            <MdFastfood className="mr-4 text-xl" />
                            Produk
                        </NavLink>
                    </li>
            ...
            <div id="sidebar-footer" className="mt-auto">
                ...
                <button
                    ...
                    className="flex w-full cursor-pointer items-center rounded-xl p-4 space-x-2 text-red-500 hover:bg-red-50 transition-all font-semibold mb-4"
                >
